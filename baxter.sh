...
# working with Baxter.
echo "Fixing /etc/resolv.conf---this should not be needed when docker/pipework work properly with DHCP"
...
#baxter_hostname="10.234.3.212"
baxter_hostname="$hostname.vx.rmit.edu.au"

# Set *Either* your computers ip address or hostname. Please note if using
# your_hostname that this must be resolvable to Baxter.
your_ip="$hostname.vx.rmit.edu.au"
